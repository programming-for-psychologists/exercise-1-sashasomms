...
square = visual.Rect(win,lineColor="black",fillColor="red",size=[100,100], pos=[-75,0])
squareB = visual.Rect(win,lineColor="black",fillColor="blue",size=[100,100], pos=[75,0])
